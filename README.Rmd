...
`r badger::badge_devel("umich-biostatistics/metaEB", "blue")` `r badger::badge_code_size("umich-biostatistics/metaEB")`
`r badger::badge_doi("", "orange") `
...
devtools::install_github('umich-biostatistics/metaEB') 
```
